...
export const initialMessages: Message[] = [
  {
    ...
    id: "0",
    content:
      "Hi! I am your NCERT assisstant. Here to help you with any of your doubts",
  },
];
...
export const getSources = (data: JSONValue[], role: string, index: number): string[] => {
  if (role === "assistant" && index >= 2 && (index - 2) % 2 === 0) {
    ...
    if (data[sourcesIndex] && (data[sourcesIndex] as unknown as Data).sources) {
      return (data[sourcesIndex] as unknown as Data).sources;
    }
  }
  return [];
};
